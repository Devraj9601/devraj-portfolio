...
function createRouterStores(initialState, config) {
  const { createMutableStore, createReadonlyStore, batch, init: init2 } = config;
...
const appCss = "/assets/styles-D3ixCyEz.css";
    ...
    motion.header,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto max-w-7xl px-6 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => go("home"), className: "font-display font-bold text-xl tracking-tight" }),
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-5xl md:text-7xl font-bold leading-[1.05] mb-4", children: [
              "Hi, I'm ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Ponntitvalasa Devraj" })
            ] }),
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "about", eyebrow: "About Me", title: "Aspiring Physical Design Engineer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
...
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Section,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: skills.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mb-4 flex h-24 w-24 items-center justify-center overflow-hidden rounded-3xl bg-neon/10 shadow-neon/10 transition-all group-hover:scale-105", children: skill.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: skill.image,
                alt: skill.name,
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl text-neon", children: skill.icon }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-foreground", children: skill.name })
          ]
        },
        skill.name
      )) })
        ...
        "article",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
              ...
              entry.score ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-3 text-sm font-semibold text-neon", children: [
...
function Certificates() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Section,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: certificates.map((cert, i) => {
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.article,
          {
            initial: { opacity: 0, y: 30 },
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-8 items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center md:text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold mb-1", children: "Ponntitvalasa Devraj — Resume 2026" }),
...
const EMAILJS_PUBLIC_KEY = "48bsfc4v0OROf-Lqt";
const EMAILJS_SERVICE_ID = "service_96q2pq1";
const EMAILJS_TEMPLATE_ID = "template_1xfdmwn";
const EMAILJS_REPLY_TEMPLATE_ID = "template_1xfdmwn";
function Contact() {
          ...
          motion.div,
          {
            ...
            children: [
              ...
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-11 h-11 rounded-xl bg-neon/10 flex items-center justify-center text-neon border border-neon/30 group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(c2.icon, { className: "w-5 h-5" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: c2.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: c2.value })
                  ] })
                ]
              },
              c2.label
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative border-t border-border py-10 px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 text-sm text-muted-foreground max-w-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "🚀 Grow. Innovate. Help others rise." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "😊 Keep learning • Keep building • Keep smiling." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/80", children: "© 2026 — Thanks for visiting my portfolio. Discover elegant VLSI craftsmanship, bold FPGA projects, and forward-thinking hardware ideas." })
        ] })
      ] }),
