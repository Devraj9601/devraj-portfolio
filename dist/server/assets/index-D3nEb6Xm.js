import { P as reactExports, H as jsxRuntimeExports } from "./server-k--5YBZm.js";
...
const FolderGit2 = createLucideIcon("folder-git-2", __iconNode$b);
const __iconNode$a = [
  [
    "path",
    {
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.header,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto max-w-7xl px-6 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => go("home"), className: "font-display font-bold text-xl tracking-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "P.Devraj" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-neon", children: "." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden lg:flex items-center gap-1", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              onClick: () => go(l.id),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "lg:hidden text-neon", onClick: () => setOpen(!open), "aria-label": "Menu", children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, {}) })
        ] }),
...
const roles = ["ECE Graduate", "VLSI Enthusiast", "Physical Design Learner", "IoT Developer"];
function useTyping() {
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "home", className: "relative min-h-screen flex items-center pt-28 pb-16 px-6 grid-bg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 -left-32 w-96 h-96 bg-neon/20 rounded-full blur-3xl animate-float" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl w-full grid lg:grid-cols-[1.3fr_1fr] gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass text-xs font-mono text-neon mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-neon animate-pulse" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl md:text-3xl font-display font-medium text-muted-foreground mb-6 h-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-neon", children: typed }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-neon animate-blink ml-1", children: "|" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mb-10 leading-relaxed", children: "Exploring the intersection of Artificial Intelligence and VLSI for next-generation computing" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 mb-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FolderGit2, { className: "w-4 h-4" }),
                    " View Projects"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.a,
                {
                  ...
                  className: "inline-flex items-center gap-2 px-6 py-3 rounded-full glass border border-neon/40 font-medium hover:neon-glow transition-all",
                  children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-tr from-neon to-accent rounded-full blur-3xl opacity-40 animate-glow" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-72 h-72 md:w-96 md:h-96 rounded-full p-1 bg-gradient-to-tr from-neon via-accent to-neon-soft animate-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full rounded-full overflow-hidden border-4 border-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: profile,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                className: "absolute -bottom-4 -left-4 glass-strong px-4 py-2 rounded-xl font-mono text-xs",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-neon", children: "CGPA" }),
                  " 9.24"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                className: "absolute -top-2 -right-4 glass-strong px-4 py-2 rounded-xl font-mono text-xs",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-neon", children: "<RTL/>" }),
                  " Verilog"
                ]
              }
            )
...
function Section({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: id2, className: "relative py-24 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-block text-xs font-mono tracking-[0.3em] text-neon mb-3 uppercase", children: [
            "// ",
            eyebrow
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-bold", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: title }) }),
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "about", eyebrow: "About Me", title: "Pursuing Physical Design engineer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-neon font-medium", children: "GIET University" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "specification → RTL → gates → silicon" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "  earning the District Science Mela Second Prize and SIH Hackathon recognition along the way." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 pt-4", children: ["VLSI", "Verilog", "Cadence Virtuoso", "ESP32", "Firebase", "FPGA"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: stats.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { className: "w-7 h-7 text-neon mb-3 group-hover:scale-110 transition-transform" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl md:text-4xl font-bold text-gradient font-display", children: s.value }),
...
const skills = [
  { name: "VLSI Design", level: 90, icon: "▣" },
  { name: "Verilog HDL", level: 92, icon: "⌬" },
  { name: "FPGA", level: 85, icon: "◈" },
  { name: "Cadence Virtuoso", level: 80, icon: "⬡" },
  { name: "ESP32", level: 90, icon: "◉" },
  { name: "IoT", level: 87, icon: "✦" },
  { name: "Firebase", level: 78, icon: "▲" },
  { name: "HTML / CSS / JS", level: 82, icon: "</>" },
  { name: "Digital Electronics", level: 93, icon: "⚡" }
];
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Section,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-5", children: skills.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          ...
          whileHover: { y: -4 },
          className: "glass rounded-2xl p-5 border border-neon/10 hover:border-neon/40 transition-all group",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-10 h-10 rounded-xl glass flex items-center justify-center text-neon text-lg font-mono group-hover:neon-glow transition-all", children: s.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: s.name })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-neon", children: [
                s.level,
                "%"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                style: { boxShadow: "0 0 12px oklch(0.85 0.2 200 / 0.6)" }
              }
            ) })
          ]
        },
...
const gietImage = "data:image/svg+xml;base64,";
const schoolImage = "data:image/svg+xml;base64,";
const education = [
  {
    institution: "GIET University",
    degree: "B.Tech in Electronics & Communication Engineering",
    date: "2022 — Present",
    description: "Specializing in VLSI, FPGA, digital systems, and embedded IoT applications.",
    image: gietImage
  },
  {
  ...
  },
  {
    ...
    date: "2018 — 2020",
    description: "Strong foundation in science and mathematics, preparing for engineering studies.",
    image: schoolImage
  }
];
function Education() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Section,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-5 lg:grid-cols-3", children: education.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.article,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/3] overflow-hidden bg-muted", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/80 via-background/30 to-transparent" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-[0.3em] text-neon font-mono mb-2", children: entry.date }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-2", children: entry.institution }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-foreground", children: entry.degree }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-6 text-foreground", children: entry.description })
            ] })
          ]
        },
        entry.institution
...
const fpga = "/assets/project-fpga-E00cUmn_.jpg";
...
const projects = [
  {
    ...
    demoUrl: "https://github.com/Devraj9601/ahb-to-apb-bridge.git"
  },
  {
    ...
    demoUrl: "https://github.com/Devraj9601/Wildlife-safety-system.git"
  }
];
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        motion.article,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-2 group-hover:text-neon transition-colors", children: p.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4 flex-1", children: p.desc }),
...
function Certificates() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Section,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: certificates.map((cert, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.article,
          {
            initial: { opacity: 0, y: 30 },
            whileInView: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-neon/10 flex items-center justify-center text-neon border border-neon/20 group-hover:neon-glow transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-6 h-6" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-neon uppercase tracking-widest", children: cert.date })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-2 group-hover:text-neon transition-colors flex-1", children: cert.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: cert.issuer }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-6 text-foreground mb-6 flex-1", children: cert.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 p-6 rounded-2xl border border-neon/20 bg-neon/5 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Add your certificates with GitHub links. Replace the template above with your actual certificate details." }) })
      ]
    }
  );
}
...
function Experience() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "experience", eyebrow: "Journey", title: "Experience & Achievements", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-3xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-neon/40 to-transparent" }),
    items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-6 border border-neon/10 hover:border-neon/40 transition-all", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-10 h-10 rounded-xl bg-neon/10 flex items-center justify-center text-neon border border-neon/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(it.icon, { className: "w-5 h-5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-neon", children: it.org })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-1", children: it.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: it.desc })
          ] })
        ]
      },
      it.title
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-8 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-32 h-40 rounded-xl bg-gradient-to-br from-neon/20 to-accent/10 border border-neon/30 flex items-center justify-center shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-12 h-12 text-neon" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-2 -right-2 px-2 py-1 rounded-md bg-neon text-primary-foreground text-[10px] font-mono font-bold", children: "PDF" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center md:text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold mb-1", children: "P. Devraj — Resume 2026" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-6", children: "ECE • VLSI / FPGA / RTL Design / IoT" }),
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Section,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[1fr_1.4fr] gap-8 max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            initial: { opacity: 0, x: -30 },
            ...
            children: [
              ...
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-11 h-11 rounded-xl bg-neon/10 flex items-center justify-center text-neon border border-neon/30 group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: "w-5 h-5" }) }),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: `w-4 h-4 transition-transform ${sent ? "translate-x-2 -translate-y-2" : "group-hover:translate-x-1"}` }),
        ...
        sendError ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl bg-destructive/10 p-4 text-sm text-destructive-foreground", children: sendError }) : null
      ] })
    }
  );
}
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative border-t border-border py-10 px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-display font-bold", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "P.Devraj" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-neon", children: "." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground text-sm ml-2 font-sans font-normal", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " — Designed in Verilog spirit."
        ] })
      ] }),
...
function Particles() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref, className: "fixed inset-0 -z-10 opacity-60" });
}
function Loader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: !done && /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 font-mono text-sm text-neon tracking-[0.3em]", children: [
          "INITIALIZING",
