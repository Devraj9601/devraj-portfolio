  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-[1fr_1.4fr] gap-8 max-w-5xl mx-auto">
        ...
        >
          {/* Hidden honeypot — blocks spam bots */}
          ...
          {sendError ? (
            <div className="text-sm text-destructive">{sendError}</div>
          ) : sent ? (
            <div className="text-sm text-emerald-400">Message sent successfully!</div>
          ) : null}
        </motion.form>
      </div>
    </Section>
